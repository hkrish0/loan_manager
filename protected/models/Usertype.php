 ...
 * @property Privilegemaster[] $privilegemasters
...
class Usertype extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('UserTypeId, UserType, Description', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'privilegemasters' => array(self::HAS_MANY, 'Privilegemaster', 'UserTypeId'),
			'usermasters' => array(self::HAS_MANY, 'Usermaster', 'UserTypeId'),
		);
	}
