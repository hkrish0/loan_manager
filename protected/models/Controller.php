...
class Controller extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('ControllerName', 'required'),
			array('ControllerName', 'length', 'max'=>25),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('ControllerId, ControllerName', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('ControllerName',$this->ControllerName,true);
