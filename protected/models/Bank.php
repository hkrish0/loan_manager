...
class Bank extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('BankName, Branch, IFSCCODE', 'required'),
			array('BankName, Branch, Address', 'length', 'max'=>45),
			array('IFSCCODE', 'length', 'max'=>25),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('BankId, BankName, Branch, IFSCCODE, Address', 'safe', 'on'=>'search'),
		);
	}
