...
<div class="column1">
	...
	<?php echo CHtml::textField('topay','',array('size'=>45,'maxlength'=>45,'label'=>false,'value'=>'')); ?>
	...
	<?php echo $form->dropDownListRow($model,'FromAccount',$headoffice, array(
	...
	<?php echo CHtml::dropDownList('ToAccount','',$bank + $branch, array(
								'class'=>'span3','label'=>false,'empty'=>'Select Bank/branch'));?>
								
					
								
	<?php echo CHtml::label('Amount',''); ?>
	<?php echo $form->textFieldRow($model,'Credit',array('size'=>12,'maxlength'=>12,'label'=>false)); ?>
...
$('#ToAccount').change(function(){
	var toaccount=$('#ToAccount :selected').text();
		$('#topay').val(toaccount);
...
function payments(){
	alert($("#verticalForm").serialize());
$.ajax({
	 
    type: "POST",
    url: "<?php echo Yii::app()->createUrl('transaction/create');?>",
